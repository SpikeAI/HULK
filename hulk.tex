...
Knowing a dictionary and a sparse coding algorithm, we may transform any data $\image$ into a set of sparse coefficients usig the above algorithm: $\coef = S(\image; \dico, z_i)$. As we have seen, some cells may learn faster than others.
...
\item compute sparse representation vector $\coef = S(\image; \dico, z_i)$
