...
For a classification task, unsupervised learning aims at learning the best dictionary to represent the input image when the categorization data is unknown.
...
This training is therefore carried out autonomously and is particularly useful for solving broader problems : image and signal compression, object detection, source separation and noise reduction in raw signals.
