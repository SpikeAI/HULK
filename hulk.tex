...
%                    METADATA
% --------------------------------------------------------------------------
\Author{\hl{Laurent} U. Perrinet \orcidA{}}%
...
\label{fig:HEH}}%
\end{figure}% remove figure 2 to here, out it after its first citation
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
...
\begin{algorithm}[H]
\caption{Homeostatic Unsupervised Learning of Kernels: $\dico = H(\image; \eta, \eta_h, N_0)$}\label{alg:shl}  %remove algorithm 2 to here, put it after its first citation
\begin{spacing}{1.5}
\begin{algorithmic}[1]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\funding{\hl{Please} add: ``This research received no external funding'' or ``This research was funded by NAME OF FUNDER grant number XXX.'' }
...
\newblock \hl{Special} issue: Computational Neuroscience: Trends in Research 2004 -
  ...
  %please confirm if we can delete it
...
%ref42 is not cited, pleace check
