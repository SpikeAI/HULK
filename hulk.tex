...
Unsupervised learning aims at learning the best dictionary to represent the input image, without using other knowledge than the input itself. Algorithms that combines such strategy with deep layer-wise structure show great succes in tasks like image denoising ~\citep{vincent2008extracting}, classification, or data preprocessing.
...
%For this type of task, recent algorithms like autoencoders ~\citep{baldi2012autoencoders} shows great success by combining unsupervised learining and deep architectures
