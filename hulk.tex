...
%\begin{itemize}
%\item Correspondence and requests for materials should be addressed to LUP (email:\Email ).
%\item Code and supplementary material available at \url{\WebsiteC/publication/perrinet-19-hulk/}.
%\end{itemize}
} %
